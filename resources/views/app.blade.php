    ...
    <div class="shell">
      ...
      <main>
        ...
        <section class="workspace">
          ...
          <section id="scheduledRunsPage" class="channels-page hidden"><div class="channels-heading"><h2>Scheduled runs</h2><button id="refreshScheduledRuns" class="btn secondary">Refresh</button></div><div class="modal-actions" role="tablist" aria-label="Scheduled run history"><button id="currentRunsTab" class="btn secondary" role="tab" aria-selected="true">Active</button><button id="archivedRunsTab" class="btn secondary" role="tab" aria-selected="false">Archived</button></div><div class="modal-actions"><label><input id="selectAllRuns" type="checkbox"> Select all on this page</label><button id="archiveSelectedRuns" class="btn secondary" disabled>Archive selected (0)</button></div><p id="scheduledRunNotice" role="status"></p><div id="scheduledRunsList" class="channels-list"></div><div class="modal-actions"><button id="previousScheduledRuns" class="btn secondary">Previous</button><button id="nextScheduledRuns" class="btn secondary">Next</button></div></section>
